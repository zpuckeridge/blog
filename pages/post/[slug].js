  ...
  return (
    <>
      ...
      <div className="mb-4 mt-4 text-center">
        <p className="uppercase font-bold text-blue-600">{frontmatter.tags}</p>
        <h1 className="font-bold text-4xl">{frontmatter.title}</h1>
        <div className="mt-4 inline-flex place-content-center dark:text-white font-bold py-2 px-2 border-2 border-gray-300 dark:border-gray-800 bg-gray-600 bg-opacity-20 text-center text-base shadow-lg rounded-xl">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="grid place-items-center">
          <div className="flex mt-4 text-gray-800 dark:text-gray-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
