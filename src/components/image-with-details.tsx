...
export default function ImageWithDetails({
	...
	return (
		<div className="w-full relative group overflow-hidden rounded-xl">
			...
			/>
			<div className="absolute inset-0 bg-black text-white bg-black/0 group-hover:bg-black/50 opacity-0 group-hover:opacity-100 rounded-xl transition-all duration-300">
