  ...
  <TooltipPrimitive.Portal>
    ...
    >
      <TooltipPrimitive.Popup
        className={cn(
          "fade-in-0 zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-fit origin-(--transform-origin) animate-in text-balance bg-primary px-3 py-1.5 text-primary-foreground text-sm duration-200 data-closed:animate-out",
          className
        )}
