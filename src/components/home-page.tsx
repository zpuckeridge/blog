...
import type { Post, Project } from "@/interfaces/content-item";
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:justify-between">
            <div className="flex flex-row gap-4 text-muted-foreground text-xs">
              ...
              <LinkWithIcon href="https://www.facebook.com/zpuckeridge/">
                Facebook
              </LinkWithIcon>
              <LinkWithIcon href="https://www.instagram.com/zpuckeridge/">
                Instagram
              </LinkWithIcon>
              <LinkWithIcon href="https://www.linkedin.com/in/zpuckeridge/">
                LinkedIn
              </LinkWithIcon>
              <LinkWithIcon href="https://github.com/zpuckeridge">
                GitHub
              </LinkWithIcon>
            </div>
        ...
        <div className="space-y-10">
          <div className="flex flex-row gap-4">
            ...
            <div className="w-full space-y-2">
              ...
              <p className="text-sm">
                ...
                . I have limited availability, but I am open to hearing about
                your project!
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-xs text-muted-foreground text-xs">
              Waging war on weak culture—building digital strongholds,
              sharpening minds, and advancing the Kingdom of God.
            </p>
