...
export default async function Home() {
  ...
  return (
    <main>
      <div className="space-y-8 my-10 px-4">
        <div className="md:flex justify-between max-w-3xl mx-auto gap-8 space-y-8 md:space-y-0">
          <h1 className="text-4xl font-semibold flex gap-2 my-auto max-w-lg">
            G&apos;day! I&apos;m Zacc — Freelance Web Developer and Systems
            Administrator
          </h1>
          <Image
            src="/avatar.jpg"
            ...
            className="md:w-32 md:h-32 w-full h-full rounded-lg border-4 border-muted my-auto"
          />
        </div>
          ...
          <div>
            <div className="space-y-4">
              <p className="dark:text-muted-foreground text-black">
                      ...
                      <div className="flex justify-between space-x-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            ...
                            has been delighting and inspiring audiences
                            worldwide, by creating some of Hollywood’s most
                ...
                . Building better artist experiences by day, Freelance Web
                Developer by night.
              </p>
              <p className="dark:text-muted-foreground text-black">
