...
export const metadata: Metadata = {
  title: "Articles",
  description:
    "Zacchary's personal corner of the internet. Here you'll find articles about faith, technology, and life.",
};
      ...
      <div className="flex flex-wrap gap-12">
        <div className="space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            ...
            articles about faith, technology, and life.
          </p>
        </div>

        <div className="w-full space-y-4">
          <h2 className="flex gap-2 underline underline-offset-4 font-semibold">
            <ClockIcon className="my-auto" /> Latest Articles
          </h2>
